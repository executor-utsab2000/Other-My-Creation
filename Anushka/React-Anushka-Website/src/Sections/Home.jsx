    ...
    <div className="container landingContainer containerMain">
      <div className="row">
        <div className="col-lg-6 order-1 order-lg-0">
          ...
          <div className="text2">ইনি হলেন <span className="text-danger">অনুষ্কা💖  , ভালোবেসে অনু বলি  , আমার প্রিয়তমা</span> ।  ইনি খুবই গুরুত্ত্বপূর্ণ আমার কাছে এবং বিশেষ আমার কাছে। 🫵🌹❤️  </div>
          ...
          <div className="socials mb-4">
            <a className='nav-link' href="https://www.instagram.com/anuska.karmakar/" target="_blank" rel="noopener noreferrer"> <i class="fa-brands fa-instagram"></i></a>
          </div>
